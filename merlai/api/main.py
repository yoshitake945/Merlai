...
async def health_check():
    ...
    return {
        "status": "healthy",
        "model_loaded": hasattr(app.state, 'music_generator') and app.state.music_generator.model is not None,
        "plugins_loaded": len(app.state.plugin_manager.plugins) if hasattr(app.state, 'plugin_manager') else 0
    }
